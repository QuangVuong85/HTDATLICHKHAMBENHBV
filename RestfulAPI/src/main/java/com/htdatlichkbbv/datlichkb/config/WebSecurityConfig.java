package com.htdatlichkbbv.datlichkb.config;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        UserDetails u2 = User.withUsername("tom").password(encrytedPassword).roles("USER").build();
        UserDetails u3 = User.withUsername("jerry").password(encrytedPassword).roles("USER").build();
